...
var HttpRequest = /** @class */ (function () {
    ...
    HttpRequest.getUser = function (username) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, "hello, " + username];
            });
        });
    };
    __decorate([
    ...
    ], HttpRequest, "getUser", null);
    return HttpRequest;
}());
HttpRequest.getUser('aaa')
    .then(function (value) { return console.log('value = ', value); })
